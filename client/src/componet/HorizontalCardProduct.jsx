...
const HorizontalCardProduct = ({ categgory, heading }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 relative">
      ...
      <div
        className="flex items-center gap-5 md:gap-6 overflow-scroll scrollbar-none transition-all "
        ref={scrollElement}
      >
        <button
        ...
        {loading
          ? loadingList.map((product, index) => {
              return (
                <div
                  key={index}
                  className="w-full min-w-[280px] md:min-w-[320px] md:max-w-[320px]  max-w-[280px] h-36  bg-white rounded-sm  flex "
                >
              ...
              return (
                ...
                >
                  ...
                  <div className="grid w-full p-4 ">
                    ...
                    <button
                      className="text-sm text-white px-3 py-0.5 rounded-full w-full bg-red-600 z-50"
