...
const UploadProduct = ({onClose, fetchData}) => {
  ...
  const handleUploadProductImage = async(e) => {
    ...
    setData({...data ,productImages: [...data.productImages, uploadImageCloud.url]})
  ...
  const handleDeleteProductImage=(index)=>{
    ...
    setData({...data, productImages: [...productImages]})
                ...
                {data.productImages.map((item, index) => {
                  return (
                    <div className="relative " key={index}>
                      ...
                      <div className="absolute bottom-0 right-0 p-1  text-white bg-red-600 rounded-full group-hover:block cursor-pointer" onClick={()=>handleDeleteProductImage(index)}>
                        <MdDelete />
                      </div>
                    </div>
                  );
